---
title: "BlockForecast"
description: "Trade on real-world events, create your own markets, and earn fees. BlockForecast is a crypto prediction market platform on Base L2."
---

BlockForecast is a prediction market platform on Base L2. You can trade on real-world outcomes, create your own markets and earn 0.5% on every trade, or integrate programmatically via the public REST API. Markets resolve automatically through a multi-agent AI oracle.
