...
The creator application is a quality gate, not a gatekeeper. BlockForecast reviews every application to make sure the platform stays free of ambiguous, low-effort, or unresolvable markets — but the bar is reasonable. If you have a specific topic area, can write clear binary questions, and have a plan to bring traders to your markets, you'll get approved. The review typically takes under 24 hours, and you'll be notified by email when a decision is made.
...
<Steps>
  ...
  <Step title="Submit and wait for review">
    Submit the form. You'll receive a confirmation email. Reviews typically complete in under 24 hours — often faster during business hours. If you haven't heard back after 48 hours, email [support@blockforecast.io](mailto:support@blockforecast.io).
  </Step>
</Steps>

## What happens after you submit

Once your application is under review, the team checks your example markets against the resolvability and quality criteria. Most decisions are delivered by email within 24 hours.

**If approved:** your account is upgraded to creator status immediately. You can access `/create` right away and launch your first market.

**If not approved:** the rejection email explains which criteria weren't met and whether you can reapply. Common reasons for rejection are ambiguous example markets or no clear distribution plan — both of which are fixable with a revised submission.
...
<AccordionGroup>
  ...
  <Accordion title="Is there a fee to apply?">
    No. The application is free. Creating a market costs only network gas (cents on Base), and some categories require a small refundable creator stake to filter out spam.
  </Accordion>
  ...
  <Accordion title="How do I know when I'm approved?">
    You'll receive an email notification. You can also check by attempting to access `/create` — if you're approved, the creation form will be available.
  </Accordion>
</AccordionGroup>
