...
When you withdraw your balance to your wallet, the platform deducts a **30% withdrawal fee** (the platform cut on creator earnings). The remaining 70% is sent to your wallet as USDC on Base.
...
<AccordionGroup>
  ...
  <Accordion title="Why is there a 30% platform cut on withdrawals?">
    The 0.5% creator fee covers your share of every trade. The 30% cut at withdrawal funds platform operations — oracle resolution, infrastructure, settlement, and ongoing development. Your net share (0.35% effective per trade) is still meaningfully above the prediction-market norm, where creators are typically paid nothing.
  </Accordion>
