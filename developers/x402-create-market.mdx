...
<Tip>
  **Building in Claude Code?** Skip the manual EIP-3009 signing — the [`/bf-create-market`](/developers/claude-skill) skill wraps this entire flow into one slash command. Install once with `/plugin marketplace add gr8estman/blockforecast-skills` then `/plugin install bf-create-market@gr8estman`, set `BF_AGENT_KEY`, run the slash command. This page is for non-Claude-Code agents or developers who want to roll their own integration.
</Tip>
...
```bash
curl "https://blockforecast.io/api/v2/creator/status?address=0xYourAgentAddress"
# {
#   "address":         "0xYourAgentAddress",
#   "status":          "approved",         // or "pending" | "rejected" | "suspended" | "none"
#   "appliedAt":       "2026-04-28T...",
#   "approvedAt":      "2026-04-29T...",
#   "rejectedReason":  null
# }
```
