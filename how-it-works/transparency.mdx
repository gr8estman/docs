...
Every data point listed below is accessible without logging in.
...
<CardGroup cols={2}>
  ...
  <Card title="Market counts" icon="grid">
    Total markets created, active markets, settled markets, and no-resolution markets — broken down by category and time period.
  </Card>
  <Card title="Resolution speed" icon="clock">
    Median and p95 resolution time by category. Lets you verify that the "under 5 minutes" claim holds in practice.
  </Card>
